package com.doudou.centurymark.user.fragment;
...
//            Toast.makeText(mContext, "消息中心", Toast.LENGTH_SHORT).show();
            ...
            Toast.makeText(mContext,"订单中心",Toast.LENGTH_SHORT).show();
        }else if (v == tvUserLocation){
            Toast.makeText(mContext,"我的地址",Toast.LENGTH_SHORT).show();
        }
    }
