package com.doudou.centurymark.utils;
...
//    public static final String BASE = "http://192.168.51.104:8080";
    ...
    // 请求Json数据基本URL
    public static final String BASE_URL_JSON = BASE+"/doudou/json/";

    // 请求图片基本URL
    public static final String BASE_URl_IMAGE = BASE+"/doudou/img";
