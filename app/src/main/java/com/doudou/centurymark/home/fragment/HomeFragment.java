package com.doudou.centurymark.home.fragment;
...
import com.doudou.centurymark.home.adapter.HomeRecycleAdapter;
import com.doudou.centurymark.home.bean.ResultBean;
import com.doudou.centurymark.user.activity.MessageCenterActivity;
...
import static com.doudou.centurymark.R.id.home;
...
//                    Toast.makeText(mContext, "https", Toast.LENGTH_SHORT).show();
    ...
    private void processData(String json) {
        if (!TextUtils.isEmpty(json)) {
            ...
            com.doudou.centurymark.home.bean.ResultBean.BannerInfoBean.ValueBean valueBean = JSON.parseObject(value, com.doudou.centurymark.home.bean.ResultBean.BannerInfoBean.ValueBean.class);
